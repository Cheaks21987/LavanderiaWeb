...
//---------------------------
		String nC  ="%"+request.getParameter("nCategoria").trim()+"%";
		String nS  ="%"+request.getParameter("nServicio").trim()+"%";
        ...
        File reportFile = new File(application.getRealPath("paginas/reporteD/reporte1.jasper"));
        
          Map parameters = new HashMap();
          parameters.clear();
          parameters.put("Pcategoria",nC);
          parameters.put("Pservicio",nS);
          parameters.put("Pfecha1",f1);
          parameters.put("Pfecha2",f2);

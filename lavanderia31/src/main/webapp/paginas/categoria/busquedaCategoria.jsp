	...
	<section class="ftco-section contact-section ftco-degree-bg">
		...
		<div class="container">
			...
			<div class="cuerpo-matenimiento-usuarios">
				...
				<%@ page import="pe.edu.universidad.entidades.jdbc.Categoria"%>
				...
				<table style="text-align: center;">
					...
					<c:forEach items="${lstResultadosCategoria}" var="categoria">
						<tr>
							...
							<td><c:out value="${categoria.nombreCategoria}"></c:out></td>
							<td><a
								href="<%=request.getContextPath() %>/ServletMantenimientoCategoria?action=editar&planId=<c:out value="${categoria.id}"></c:out>">editar</a></td>
							<td><a
								href="<%=request.getContextPath() %>/ServletMantenimientoCategoria?action=eliminar&idUsuarioEliminar=<c:out value="${categoria.id}"></c:out>"
